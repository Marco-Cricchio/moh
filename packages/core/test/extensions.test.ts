...
describe("@moh/extension contract", () => {
  test("defineExtension is an identity tag; apiVersion parses", () => {
    ...
    // ADR-0031/ADR-0032/ADR-0033/ADR-0038: the ask outcome, the two
    // observability seams, the beforeTurn hook and the control channel.
    expect(parseApiVersion(MOH_EXTENSION_API_VERSION)).toEqual({ major: 1, minor: 3 });
