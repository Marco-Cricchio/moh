 ...
 * guessing. The shipped subscription catalogs (#156/#164, generated by
 * moh's own pipeline — ADR-0046) stay the metadata source of truth; a live
 * listing only *adds* models the shipped file does not yet carry, so newly
 * released models appear without a moh release.
 *
 ...
 *    Deliberately static: its single row is hand-maintained in
 *    `baseten.overrides.json` (ADR-0046), so a catalog regeneration is its
 *    update story.
 *
