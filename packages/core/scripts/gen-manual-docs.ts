...
const files = ["getting-started.md", "what-moh-offers.md", "sessions.md", "providers-and-models.md", "permissions.md", "mcp.md", "skills-and-workflow.md", "memory-and-compaction.md", ...GENERATED].sort();
const index: string[] = [
  "# moh user manual",
  "",
