...
export const THEMES = {
  "tokyo-night": { label: "Tokyo Night", fg: "#c0caf5", accent: "#7aa2f7", dim: "#565f89", muted: "#9aa5ce", ok: "#9ece6a", warn: "#e0af68", err: "#f7768e", purple: "#bb9af7", border: "#292e42", bg: "#16161e", surface: "#1a1c27", surfaceRaised: "#20232f", selection: "#2a3352" },
  ...
  "lava": { label: "Lava", fg: "#ffe8d6", accent: "#ff6a00", dim: "#8a4a2a", muted: "#c8a088", ok: "#ffd23f", warn: "#ff2e2e", err: "#ff1a1a", purple: "#ff4fa3", border: "#5a2c18", bg: "#1c0e08", surface: "#25130b", surfaceRaised: "#2e1810", selection: "#472318" },
